...
export const About = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            targetOffset.current = Math.abs(rect.top);
        };
        ...
        <section className={s.about} ref={sectionRef}>
            <div className={"container_grid"}>
                ...
                <div className={s.about_content}>
                    <h3 className={"header_common"}>
                        Вітаємо вас від імені Адвокатського Об&apos;єднання &quot;Ястребова і Партнери&quot;!
                    </h3>
                    <div className={clsx(s.about_text, "common_text_small")}>
                        <p>
                            Адвокатське об&apos;єднання &quot;Ястребова і Партнери&quot; — це команда досвідчених правників, які
                            працюють із відданістю та фокусом на результат. Ми спеціалізуємось на захисті
                            прав людини й ведемо справи різної складності, включаючи резонансні та міжнародні
                            кейси.
                        </p>

                        <p>
                            Кожен клієнт отримує індивідуальний підхід — ми глибоко вивчаємо обставини, щоб
                            вибудувати ефективну стратегію правового захисту.
                        </p>

                        <p>
                            Повна конфіденційність: усі отримані дані залишаються під надійним захистом.
                        </p>

                        <p>
                            Наша юридична допомога охоплює ключові сфери: кримінальне, цивільне, адміністративне
                            та міжнародне право. Супроводжуємо звернення до ЄСПЛ, коли йдеться про порушення
                            основоположних прав.
                        </p>

                        <p>
                            Ми допомогли багатьом людям відстояти свої права — і продовжуємо боротися за
                            справедливість кожного дня.
                        </p>
                    </div>
                </div>
                ...
                <motion.div className={s.about_blockquote}>
                    ...
                    >
                        &quot;Юрист — це не тільки про закони. Це про людяність, сміливість і здатність стояти
                        на стороні правди.&quot;
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        viewport={{ once: false, amount: 0.3 }}
                        className={s.about_avatar}
                    >
                        <Image
                            className={s.about_avatar_img}
                            src={AvatarImg}
                            alt="avatar"
                            width={200}
                            height={180}
